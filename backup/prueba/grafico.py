...
import time
import sys
sys.path.append(r'C:\Users\lahernandez\Desktop\Luis H\sistemaexperto')
...
class Diagnostico:
    def __init__(self,sisExp,sintomas):
        ...
        self.bcontenedorBotones.pack(anchor=tk.CENTER)
